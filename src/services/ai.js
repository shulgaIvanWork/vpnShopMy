...
- За каждую оплату приглашенного получаете купон 10% скидки
- Купон действует 1 год с момента получения, работает один раз, применится автоматически
