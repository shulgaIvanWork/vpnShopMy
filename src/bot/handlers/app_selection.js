      ...
      const appInstructions = {
        v2ray: {
          ...
          message: `📱 Инструкция по настройке v2ray:\n\n` +
            ...
            `   • macOS: https://github.com/2dust/v2rayU/releases\n\n` +
            `2️⃣ Установите и откройте приложение\n\n` +
            `3️⃣ Нажмите "+" или "Добавить подключение"\n\n` +
            `4️⃣ Выберите "Добавить из ссылки" (Import from URL)\n\n` +
            `5️⃣ Вставьте скопированный VPN ключ\n\n` +
            `6️⃣ Подключитесь к серверу\n\n` +
        ...
        onexray: {
          ...
          message: `📱 Инструкция по настройке oneXray:\n\n` +
            `1️⃣ Скачайте приложение:\n` +
            `   • iOS: App Store\n` +
            `   • macOS: https://github.com/XTLS/oneXray\n\n` +
            `2️⃣ Установите и откройте приложение\n\n` +
            `3️⃣ Нажмите "+" для добавления подключения\n\n` +
            `4️⃣ Выберите "Import from URL" или "Добавить из ссылки"\n\n` +
            `5️⃣ Вставьте скопированный VPN ключ\n\n` +
            `6️⃣ Подключитесь к серверу\n\n` +
            `✅ Готово! VPN активен.`
        },
        hiddify: {
          ...
          message: `📱 Инструкция по настройке Hiddify:\n\n` +
            ...
            `   • iOS: App Store\n` +
            `   • Desktop: https://hiddify.com\n\n` +
            `2️⃣ Установите и откройте приложение\n\n` +
            `3️⃣ Нажмите кнопку "+" или "Add Profile"\n\n` +
            `4️⃣ Выберите "Import from URL"\n\n` +
            `5️⃣ Вставьте скопированный VPN ключ\n\n` +
            `6️⃣ Нажмите "Connect"\n\n` +
            `✅ Готово! Вы защищены.`
        }
